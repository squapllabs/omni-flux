                ...
                <CustomCard>
                    <div className={Styles.mainContent}>
                        ...
                        <div className={Styles.dataRows}>
                            ...
                            <div className={Styles.rightData}>
                                {''}
                                {stockOutwardData?.site_engineer_data?.first_name + " " + stockOutwardData?.site_engineer_data?.last_name
                                    ? `${stockOutwardData?.site_engineer_data?.first_name + " " + stockOutwardData?.site_engineer_data?.last_name}`
                                    : 'Not Provided'}
                            </div>
                        </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            {stockOutwardData?.stock_outward_details?.length === 0 ? (
                                ...
                                stockOutwardData?.stock_outward_details?.map((item: any, index: any) => {
                                    return (
                                        <tr>
                                            <td>
                                                {index + 1}

          ...
          <div className={Styles.mainContent}>
            ...
            <div className={Styles.dataRows}>
              ...
              <div className={Styles.rightData}>
                ...
                ? `${format(new Date(getOneLead?.lead_enquiry_tenders?.[0]?.tender_issue_date),'MMM dd, yyyy')}`
                    : 'Not Provided'}
              </div>
            </div>
            <div className={Styles.dividerStyle}></div>
            <div className={Styles.dataRows}>
              ...
              <div className={Styles.rightData}>
                ...
                ? `${format(new Date(getOneLead?.lead_enquiry_tenders?.[0]?.tender_due_date),'MMM dd, yyyy')}`
                    : 'Not Provided'}
              </div>
            </div>
            <div className={Styles.dividerStyle}></div>

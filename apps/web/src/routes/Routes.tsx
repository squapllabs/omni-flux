...
import PurchaseView from '../component/purchaseOrder/purchaseView';
...
const AppRoutes = () => {
  ...
  const ProtectedPurchaseOrderView = withLayoutAndProtection(PurchaseView);
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/purchase-order/:id" element={<ProtectedPurchaseViewByvendor />} />
      </Routes>
    </div>
  );
};

...
const AppRoutes = () => {
  ...
  const ProtectedPurchaseRequestItemView = withLayoutAndProtection(PurchaseRequestItemView);
  return (
    <div>
      <Routes>
        <Route path="/" element={<Login setIsAuth={setIsAuth} />} />
        ...
        <Route path="/request-items" element={<ProtectedPurchaseRequestItemView />} />
      </Routes>
    </div>
  );
};

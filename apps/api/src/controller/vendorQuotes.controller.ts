...
const createVendorQuotes = catchAsync(async (req, res) => {
    ...
    try {
        const vendorQuotes = await vendorQuotesService.createVendorQuotes(
            req.body
        );
...
const updateVendorQuotes = catchAsync(async (req, res) => {
    ...
    try {
        const vendorQuotes = await vendorQuotesService.updateVendorQuotes(
            req.body
        );
        res.send(vendorQuotes);
    } catch (err) {
...
const getAllVendorQuotes = catchAsync(async (req, res) => {
    ...
    try {
        const vendorQuotes =
            await vendorQuotesService.getAllVendorQuotes();
        res.send(vendorQuotes);
    } catch (err) {
        handleError(new ErrorHandler(errorText, methodName, err), res);
    }
...
const searchVendorQuotes = catchAsync(async (req, res) => {
    ...
    try {
        const vendorQuotes = await vendorQuotesService.searchVendorQuotes(
            req.body
        );
        res.send(vendorQuotes);
    } catch (err) {
